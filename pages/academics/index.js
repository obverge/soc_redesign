		...
		<>
			...
			<section className="mx-auto max-w-7xl px-5 py-12 sm:px-8">
				<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
					<QuickLinkCard href="/academics/co-op" title="Co-op" description="Work term dates, ASM-CE contacts, and PEGNL licensure guidance." icon="work" imageSrc="/res/academics/image-1790210716313.png" />
					<QuickLinkCard href="/academics/support" title="Engineering One" description="The Student Success Centre and campus academic resources." icon="support" imageSrc="/res/academics/image-1790210488938.png" />
					<QuickLinkCard href="/academics/disciplines" title="Disciplines" description="Overview of all eight engineering programs at MUN." icon="category" imageSrc="/res/academics/deans_j2025.png" />
